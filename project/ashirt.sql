...
Source Database       : ashirt

Target Server Type    : MYSQL
Target Server Version : 80016
File Encoding         : 65001

Date: 2019-09-10 02:02:25
*/
...
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES ('190', 'changsha', 'winnerwll@163.com', null, '', '111', '');
...
INSERT INTO `account` VALUES ('12345678', 'changsha', 'winnerw@163.com', null, 'wulan', '111', '1393993687');
...
INSERT INTO `comments` VALUES ('192', 'lll', '2', '0', '2019-09-09 15:25:07', '190');
...
CREATE TABLE `design` (
  ...
  `design_time` datetime DEFAULT NULL,
  ...
  `thought` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`,`style_id`,`publish`,`product_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- Records of style
-- ----------------------------
INSERT INTO `style` VALUES ('150', 'grey', '35', 'sadfadsgda', '/images/style_picture/fleece-01.jpg', '2019-09-05 11:22:53', 'fleece', null);
INSERT INTO `style` VALUES ('151', 'green', '30', 'sdfghjgffghjk', '/images/style_picture/T-shirt-01.jpg', '2019-09-05 15:18:13', 'Tshirt', null);
INSERT INTO `style` VALUES ('152', 'purple', '50', 'ajhrsghjekwl', '/images/style_picture/skirt-01.jpg', '2019-09-06 15:19:12', 'skirt', null);
